...
const navigation = [
  ...
  { name: '帯替え編集', href: '/editor', icon: EditIcon },
  { name: '公開ページ', href: '/published', icon: GlobeIcon },
  { name: '提案管理', href: '/proposals', icon: SendIcon },
  { name: '会社情報設定', href: '/settings', icon: SettingsIcon },
]
